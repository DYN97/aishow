<template>
  <div class="detailBox">
    ...
    <div class="paybtnBox clearfix" style="margin-bottom: 20px">
      <a
              href="mailList.aspx"
            ...
            me.$api.orderapi.GetOrderDetail(me.detail_id).then(res => {
                if (res.data.statusCode == "200") {
                    ...
                    switch (parseInt(me.apply_status)) {
                        ...
                        case 0:
                            me.statusText =
                                '<i class="iconfont " style="color:#f57d58;margin-right: 5px;font-size: 18px">&#xe620;</i><span  style="color:#f57d58" class="iCOrigin">待审核</span>';
                            break;
                        case 1:
                            me.statusText =
